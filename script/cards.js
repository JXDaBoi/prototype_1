...
function cardAni(a) {
  if (a == 1 && window.innerWidth <= 767 && topFlag[0] == 0) {
    ...
    topFlag[0] = 0;
  } else if (a == 1 && window.innerWidth >= 768) {
  ...
  if (a == 2 && window.innerWidth <= 767 && topFlag[1] == 0) {
    ...
    topFlag[1] = 0;
  } else if (a == 2 && window.innerWidth >= 768) {
  ...
  if (a == 3 && window.innerWidth <= 767 && topFlag[2] == 0) {
    ...
    topFlag[2] = 0;
  } else if (a == 3 && window.innerWidth >= 768) {
  ...
  if (a == 4 && window.innerWidth <= 767 && topFlag[3] == 0) {
    ...
    topFlag[3] = 0;
  } else if (a == 4 && window.innerWidth >= 768) {
  ...
  if (a == 5 && window.innerWidth <= 767 && topFlag[4] == 0) {
    ...
    topFlag[4] = 0;
  } else if (a == 5 && window.innerWidth >= 768) {
    location.href = "pages/five.html";
  }
  if (a == 6 && window.innerWidth <= 767 && topFlag[5] == 0) {
    ...
    topFlag[5] = 0;
  } else if (a == 6 && window.innerWidth >= 768) {
    location.href = "pages/six.html";
  }
